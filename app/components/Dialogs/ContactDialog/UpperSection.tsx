  ...
  return (
    <div className="upper-section">
      <div className="contact-details">
        <div className="form-group contact-id">
          <input type="text" className="input-field" defaultValue="634" />
          <input
            type="text"
        ...
        <div className="form-group">
          <label>Name</label>
          <input type="text" className="input-field" defaultValue="Jane" />
          <input
            type="text"
            className="input-field"
      ...
      <div className="right-section">
        <div className="top-section">
          <div className="right-field">
            <label>Code</label>
            <input type="text" className="input-field" defaultValue="NIKOLJ" />
          </div>
          <div className="right-field">
            <label>Credit Amt</label>
            <input type="text" className="input-field" defaultValue="$0.00" />
          </div>
        </div>
        <div className="bottom-section">
          ...
          <div className="right-field">
            ...
            <input type="text" className="input-field" defaultValue="0.000" />
          </div>
        </div>
      </div>
    </div>
